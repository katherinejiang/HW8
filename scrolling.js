$( document ).ready(function() {
    ...
    $("#stepTwo").click(function(){
        ...
        $('.pot').attr('src', 'assets/kombucha-12.svg');
        $('.pot').css("z-index", 2);
        var potCopy = $(".pot").clone().css({position:"absolute","z-index":"1"}).attr("src","assets/kombucha-31.svg");
        $('.pot').after(potCopy).fadeOut('slow');
